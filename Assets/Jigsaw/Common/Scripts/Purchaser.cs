...
public class Purchaser : MonoBehaviour, IStoreListener
{
    ...
    public void InitializePurchasing()
    {
        ...
        builder.AddProduct(removeAdProductId, ProductType.NonConsumable);
    ...
    {
#if UNITY_WEBGL
        FacebookController.instance.Pay(iapItems[index].productID, () =>
        {
            onItemPurchased(iapItems[index], index);
        });
#else
    ...
    {
        if (String.Equals(args.purchasedProduct.definition.id, removeAdProductId, StringComparison.Ordinal))
        {
            var removeAdButton = GameObject.FindWithTag("RemoveAdButton");
            var restoreButton = GameObject.FindWithTag("RestoreButton");
            if (removeAdButton != null) removeAdButton.SetActive(false);
